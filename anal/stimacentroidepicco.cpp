...
int main() {
    ...
    //calcolo incertezze considerando che la distribuzione per i dati nelle y è di poisson e applicando alla formula sopra la propagazione degli errori
    ...
    //Per calcolare la sigma del delta x applico il teorema delle varianze, e ottengo la somma in quadratura delle varianze
